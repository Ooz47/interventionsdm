...
class __TwigTemplate_58beb7f89fd2debb2f4359c2ce65b507 extends Template
{
    private $source;
    private $macros = [];
...
($context["long"] ?? null)) ? (("filter-tips__item--id-" . \Drupal\Component\Utility\Html::getClass($this->sandbox->ensureToStringAllowed(CoreExtension::getAttribute($this->env, $this->source, $context["item"], "id", [], "any", false, false, true, 50), 50, $this->source)))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "core/themes/olivero/templates/filter/filter-tips.html.twig", "C:\\laragon\\www\\interventions-democratiques.fr.d11\\web\\core\\themes\\olivero\\templates\\filter\\filter-tips.html.twig");
    }
