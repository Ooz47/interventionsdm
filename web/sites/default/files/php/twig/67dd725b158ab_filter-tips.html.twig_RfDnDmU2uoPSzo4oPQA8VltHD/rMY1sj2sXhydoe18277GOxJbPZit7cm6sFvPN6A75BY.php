...
class __TwigTemplate_73f35d69b2c71cea0e1c38019fe7cbcf extends Template
{
    private $source;
    private $macros = [];
...
($context["long"] ?? null)) ? (("filter-tips__item--id-" . \Drupal\Component\Utility\Html::getClass($this->sandbox->ensureToStringAllowed(CoreExtension::getAttribute($this->env, $this->source, $context["item"], "id", [], "any", false, false, true, 50), 50, $this->source)))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "core/themes/claro/templates/filter/filter-tips.html.twig", "C:\\laragon\\www\\interventions-democratiques.fr.d11\\web\\core\\themes\\claro\\templates\\filter\\filter-tips.html.twig");
    }
